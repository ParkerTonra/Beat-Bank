...
from PyQt6.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QTableWidget, QGridLayout
...
class SideBar(QWidget):
    ...
    def init_buttons(self):
        ...
        self.buttons = [
            QPushButton("Add Playlist"), QPushButton("Remove Playlist"),
            QPushButton("Refresh List"), QPushButton("Settings")
        ]

        # Setting up button styles and connections
        for i, button in enumerate(self.buttons):
            button.setStyleSheet("background-color: #444444; color: white;")
            self.buttons_layout.addWidget(button, i // 2, i % 2)  # Arrange buttons in 2x2 grid
